...
import type { Category as _Category, Product as _Product, Rating as _Rating, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async _resetSKRHaven(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor._resetSKRHaven();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getProductById(arg0: CatalogIndex): Promise<Product> {
        if (this.processError) {
            try {
...
function from_candid_variant_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "groceries" in value ? Category.groceries : "petCare" in value ? Category.petCare : "personalCare" in value ? Category.personalCare : "household" in value ? Category.household : "electronics" in value ? Category.electronics : value;
}
